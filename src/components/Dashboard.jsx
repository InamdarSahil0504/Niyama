            ...
            <div className="fixed bottom-0 left-0 right-0 bg-gray-900 border-t border-gray-800">
                <div className="max-w-lg mx-auto flex justify-around items-center py-3">
                    ...
                    <button
                        ...
                        className={`flex flex-col items-center gap-1 px-4 py-1 rounded-lg transition ${activeTab === 'about' ? 'text-indigo-400' : 'text-gray-600'
                            }`}
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <button
                        onClick={signOut}
                        className="flex flex-col items-center gap-1 px-4 py-1 rounded-lg transition text-gray-600 hover:text-red-400"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
